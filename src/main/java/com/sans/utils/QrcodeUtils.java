...
public class QrcodeUtils {
     ...
     */
    private static void overlapImage(final BufferedImage image, String ignoredFormat, final InputStream logo, MatrixToLogoImageConfig logoConfig) throws IOException {
